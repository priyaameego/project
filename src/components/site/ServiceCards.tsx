...
import { GiToothbrush, GiDiamonds, GiMagicSwirl } from "react-icons/gi";
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          {CARDS.map((card, i) => (
            <motion.div
              ...
              className="group relative flex flex-col overflow-hidden rounded-[2rem] bg-white shadow-[0_20px_50px_-25px_rgba(11,47,92,0.2)] hover:shadow-[0_40px_80px_-25px_rgba(11,47,92,0.35)] border border-[#E5ECF3] transition-all duration-500 hover:-translate-y-2"
            >
              <div className="relative h-48 sm:h-56 overflow-hidden">
                ...
                {/* Float Icon */}
                <div className="absolute top-4 left-4 grid h-12 w-12 place-items-center rounded-2xl bg-white/20 backdrop-blur-md border border-white/30 text-white text-2xl shadow-lg">
                  {card.icon}
                </div>
